...
class SavingsGoal:
    ...
    def __init__(self, name, target_amount, monthly_contribution=0.00):
    ...
    def get_estimated_months(self):
        ...
        return math.ceil(remaining_amount / self.monthly_contribution)
...
if __name__ == "__main__":
    ...
    print(f"Remaining amount: " f"${emergency_fund.get_remaining_amount():.2f}")
    print(f"Estimated months: " f"{emergency_fund.get_estimated_months()}")
